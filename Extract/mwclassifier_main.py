...
if __name__ == '__main__':
    ...
    # Convert file to 
    fpath = "D:\\Viren\\AIKD\\Malware\\malware-dection\\TestFile\\temp\\AnyDesk.exe"
    png = covert_to_png(fpath)

    # Loading the Malware_Classifier_model.h5
    with open('D:\Viren\AIKD\Malware\malware-dection\Classifier\Malware_Classifier\pickel_malware_classifier.pkl','rb') as file:
        pickle_model = pickle.load(file)
    file.close()

    # Loading list of malware family classes
    with open('D:\Viren\AIKD\Malware\malware-dection\Classifier\Malware_Classifier\Malware_classes.pkl','rb') as file1:
